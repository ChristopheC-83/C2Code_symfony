 ...
 */
final class Version20240916041537 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE articles (id INT AUTO_INCREMENT NOT NULL, language_id INT NOT NULL, type_id INT DEFAULT NULL, visible TINYINT(1) NOT NULL, title VARCHAR(255) NOT NULL, position INT NOT NULL, thumbnail VARCHAR(255) NOT NULL, pitch LONGTEXT NOT NULL, text LONGTEXT DEFAULT NULL, INDEX IDX_BFDD316882F1BAF4 (language_id), INDEX IDX_BFDD3168C54C8C93 (type_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
